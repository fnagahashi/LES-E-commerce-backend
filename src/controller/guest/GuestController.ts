...
export class GuestController {
    ...
    async create(req: Request, res: Response): Promise<void> {
        try {
            ...
            const guestAddresses = addresses.map((addr: any) => 
                new Address(
                    addr.cep,
                    addr.street,
                    addr.neighborhood,
    ...
    async findAll(req: Request, res: Response): Promise<void> {
        try {
            ...
            const guests = await this.facade.list(guestInstance, "buscarTodos");
    ...
    async findById(req: Request, res: Response): Promise<void> {
        try {
            ...
            const guests = await this.facade.list(guestInstance , "buscarPorId");
    ...
    async findByCpf(req: Request, res: Response): Promise<void> {
        try {
            ...
            const guests = await this.facade.list(guestInstance, "buscarPorCPF");
    ...
    async update(req: Request, res: Response): Promise<void> {
        try {
            ...
            if (updateData.addresses && Array.isArray(updateData.addresses)) {
                updateData.addresses = updateData.addresses.map((addr: any) => 
                    new Address(
                        addr.cep,
                        addr.street,
                        addr.neighborhood,
