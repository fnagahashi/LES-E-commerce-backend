...
//         new Sale("", "", "percentual", 0, new Date()),
//         "findAll"
//       )) as Sale[];
...
//       const sales = await this.facade.list(
//         new Sale(codigoSale, "", "percentual", 0, new Date()),
//         "findByCode"
//       );
...
//       Object.assign(saleAtual, dadosAtualizacao);

//       const saleAtualizado = await this.facade.update(saleAtual);
...
//       const saleAtual = sales[0];
//       const dadosAtualizacao = { ativa: false };
...
//       Object.assign(saleAtual, { ativa: true });
