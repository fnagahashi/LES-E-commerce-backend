...
describe("Registro de Pedido - Pagamento com cartão + cupom", () => {
  let token: string;
  beforeAll(async () => {
  ...
  test("deve registrar pedido com pagamento via cartão + cupom", async () => {
  const response = await request(app)
    ...
    .send({
      ...
      payments: [
        {
          paymentMethod: "cupom_sale",
          paymentValue: "50.00",
          paymentStatus: "APPROVED",
          cupomId: "0f40d192-3443-4668-b0db-ca5e552fcc06",
        },
        {
